...
const DeveloperComparisonChart = () => {
    ...
    return (
        <div
            ...
            <h2 style={{ margin: "0 0 8px 0", fontSize: "18px", fontWeight: 600, color: "#111827" }}>Developer Productivity Improvement</h2>
            <p style={{ margin: "0 0 20px 0", fontSize: "14px", color: "#6b7280" }}>Comparing velocity before and after Copilot adoption</p>
            <ResponsiveContainer width="100%" height={350}>
                <BarChart data={data} layout="vertical">
                    <CartesianGrid strokeDasharray="3 3" stroke="#e5e7eb" />
                    <XAxis type="number" stroke="#6b7280" style={{ fontSize: "12px" }} />
                    <YAxis type="category" dataKey="developer" stroke="#6b7280" style={{ fontSize: "12px" }} width={120} />
                    <Tooltip
                        contentStyle={{
            ...
            <div style={{ marginTop: "16px", fontSize: "12px", color: "#6b7280" }}>
                <p style={{ margin: 0 }}>💡 Darker green indicates higher productivity improvement</p>
            </div>
        </div>
    );
};
